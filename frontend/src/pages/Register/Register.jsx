...
const mySchema=yup.object({
  ...
  name:yup.string().required("Name is Required").min(3,"must be more than 3 chars").max(10,"must be less than 10"),
  phone:yup.string().required("phone is required").length(11,"must be 11 digit") ,
...
async function sendUserData(values) {
  ...
  return (
    <div className="w-75 m-auto p-5">
      ...
      {isPost==true?<div className="alert alert-success text-center ">Your account is created successefuly</div>:""}  
      ...
      <form onSubmit={myFormik.handleSubmit}>
        ...
        <button type="submit" className="rounded-4 text-white p-2 bg-warning w-100">
